...
@section('content')
          ...
          <?php
        echo "<h1 class='text-success'><u> Category: ".$group['name']."</u></h1>";
               ...
               echo "<div class='col-8 border' >";
                ...
                echo"<div class='col-4 border text-center' >";
                      ...
                      //  echo "<h1>".$item['avatar']."</h1>";
                                echo "<img class='product_avatar ' src='../storage/".$item['avatar']."' alt='picture of product'>";
                                echo "<br/>";
